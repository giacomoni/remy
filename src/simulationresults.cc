...
template <>
SimulationRunData & SimulationResults< WhiskerTree >::add_run_data( const NetConfig & config, double interval )
{
...
template <>
SimulationRunData & SimulationResults< FinTree >::add_run_data( const NetConfig & config, double interval )
{
...
template <>
SimulationResultBuffers::SimulationsData SimulationResults< WhiskerTree >::DNA( void ) const
{
...
template <>
SimulationResultBuffers::SimulationsData SimulationResults< FinTree >::DNA( void ) const
{
  SimulationResultBuffers::SimulationsData ret;
